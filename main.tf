...
locals {
  pro_tenant_id = coalesce(data.zenml_server.zenml_info.pro_workspace_id, "")
  ...
  zenml_pro_tenant_iam_role_name = local.pro_tenant_id != null ? "zenml-${local.pro_tenant_id}" : ""
  zenml_pro_tenant_iam_role = local.pro_tenant_id != null ? "arn:aws:iam::${local.zenml_pro_aws_account}:role/${local.zenml_pro_tenant_iam_role_name}" : ""
